export function DoodleFlower({ className = "", style = {} }) {
  return (
...
export function DoodleLeaf({ className = "", style = {} }) {
  return (
...
export function DoodleWreathLeft({ className = "", style = {} }) {
  return (
...
export function DoodleWreathRight({ className = "", style = {} }) {
  return (
    <svg viewBox="0 0 60 200" fill="none" xmlns="http://www.w3.org/2000/svg"
      className={className} style={style} aria-hidden="true">
...
export function DoodleCurly({ className = "", style = {} }) {
  return (
...
export function DoodleBow({ className = "", style = {} }) {
  return (
