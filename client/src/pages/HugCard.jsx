...
const CSS = `
  ...
  */
  ...
  .hug-cart {
    ...
    font-weight: 800;
    cursor: pointer;
    box-shadow: 0 10px 28px rgba(190,24,93,0.16);
  }
  .hug-cart:hover { transform: translateY(-1px); }
...
export default function HugCard() {
  ...
  const line1 = customData?.line1 || t("hugCard.frontTitleLine1", "Happy");
  const line2 = customData?.line2 || t("hugCard.frontTitleLine2", "Mother's");
  const line3 = customData?.line3 || t("hugCard.frontTitleLine3", "Day!");
  ...
  return (
    <div className="hug-page">
          ...
          >
            ...
            <div
              ...
              style={{
                width: armWidth,
                opacity: armOpacity,
                transition: isDragging ? "none" : "width 0.2s ease, opacity 0.2s",
              }}
            >
        ...
        >
          <div className="card-bottom-content">
            {customData?.msg ? (
              ...
              <>
                ...
                <p className="msg-thiiis" style={{
                  ...
                  transition: isDragging ? "none" : "all 0.3s ease 0.05s",
                }}>
            ...
            <span className="heart-big" style={{
              ...
              transition: isDragging ? "none" : "all 0.3s ease 0.1s",
            }}>
              ❤️
            </span>
          </div>
      ...
      <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", justifyContent: "center" }}>
        {dataParam ? (
          <Link to="/create-hug-card" className="hug-cart" style={{ textDecoration: "none" }}>
            <Edit2 size={16} /> Create your own ✨
          </Link>
        ) : (
          <>
            <Link to="/create-hug-card" className="hug-cart" style={{ textDecoration: "none", background: "#be185d", color: "#fff", borderColor: "#be185d" }}>
