...
export default function CreateShagun() {
  ...
  useEffect(() => {
    applySeo({
      title: "Create Digital Shagun & Eidi Envelopes | Petals and Words",
      description: "Send traditional monetary gifts (Shagun/Eidi) in digital envelopes with clean printable QR codes. Fast, secure, and regulatory-compliant.",
      path: "/shagun",
    });
  }, []);
        ...
        handler: async (paymentResponse) => {
          try {
            ...
            if (verifyRes.ok && verifyData.ok) {
              navigate(`/shagun/success/${orderData.shagunId}`);
            } else {
      ...
      <header className="shagun-header sticky top-0 z-30 w-full">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link to="/" className="text-sm font-semibold text-[#7c4343] hover:opacity-80 text-decoration-none">
              {t("common.home", "Home")}
            </Link>
            <LanguageSwitcher />
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 mt-8 flex-grow">
        <div className="text-center mb-10">
          ...
          <p className="max-w-xl mx-auto text-[#705f58] text-sm md:text-base leading-relaxed">
            ...
            Slip it into a standard physical envelope. Receivers scan and claim directly to their UPI!
          </p>
        </div>
