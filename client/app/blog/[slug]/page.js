...
// Per-post metadata injected into <head> server-side
...
export default async function BlogPostPage({ params }) {
  ...
  return (
    <main className="mx-auto min-h-screen w-full max-w-3xl px-4 py-8 sm:py-12">
      ...
      <article
        className="rounded-[2rem] border border-rose-200/70 bg-white/95 p-6 shadow-xl shadow-rose-200/30 sm:p-10"
      >
        {/* Breadcrumb */}
        ...
        {/* Table of contents */}
        <nav
          className="mt-6 rounded-xl border border-stone-100 bg-stone-50/70 p-4"
