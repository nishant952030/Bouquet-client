      ...
      <header className="shagun-header sticky top-0 z-30 w-full print-hide bg-white/95">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/shagun" className="text-sm font-semibold text-[#7c4343] text-decoration-none">
              Create Another
            </Link>
            <Link href="/" className="text-sm font-semibold text-stone-500 text-decoration-none">
              Home
            </Link>
          </div>
        </div>
